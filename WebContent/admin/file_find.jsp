...
String sql = "SELECT FILE_PATH,MODEL_NAME,FILE_ID,FILE_NUM,FILE_NAME,FILE_VER,FILE_TIME,USER_ID from file a,model b where a.MODEL_ID=b.MODEL_ID and a.FILE_NAME = '"+request.getParameter("filename")+"'";
